...
@set FLASHFILE=C:\Users\Ed\AppData\Local\Arduino15\packages\MightyCore\hardware\avr\2.0.8\bootloaders\optiboot_flash\bootloaders\km_optiboot_mighty\optiboot_flash_m1284pa.hex
@set MK=atmega1284p
@set PRG=avrispmkII
@set PORT=usb
